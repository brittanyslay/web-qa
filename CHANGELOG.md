...
Initial release: the 11-gate pre-launch QA process as a Claude skill, plus `qa-scan.py`, a zero-dependency scanner covering functionality, security, SEO, accessibility, performance, and analytics/tag checks.
