...
| 11 | **Post-launch verification** | `11-post-launch.md` | A form that broke under real traffic |

Gates 1-10 run before launch; gate 11, post-launch, is not optional either. It's when real traffic finds what you didn't.
